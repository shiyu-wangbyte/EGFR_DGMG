...
def main(rank, args):
    ...
    for epoch in range(args['nepochs']):
        ...
        if epoch%50 == 0:
            torch.save({'model_state_dict': model.state_dict()},args['log_dir']+'/'+str(epoch)+'_checkpoint.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset',
                        help='dataset to use')
    parser.add_argument('-m', '--model',default='ZINC',choices=['CHEMBL', 'ZINC'], help='pre-trained model to use')
